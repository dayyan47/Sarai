  ...
  Widget _buildPhoneLayout() {
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          _removeDeletedAdsFromFavAds(
              ads); // to unFav ads that were deleted by users
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final adData =
                            favoriteAds[index].data() as Map<String, dynamic>;
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Center(
                            child: Container(
                                width: width / 2,
                                child:
                                    AdHomeScreen(adData: adData, adId: adId)));
                      });
                });
          } else {
            return const Center(
